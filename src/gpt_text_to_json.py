...
def process_ai(text):
    ...
    while retries < 3:
      try:
        ...
        # gpt-4-0613
        # gpt-3.5-turbo
        messages = [{"role": "user", "content": f"I will provide you text from a business card pls provide me json which will follow this structure: name,email,phone_number,company_name,adress,descreption. If some fiels is missing just fill them with none: {text}."}],
        model="gpt-3.5-turbo")
